...
if (process.env.VUE_APP_ZAMMAD_CHAT_ENABLED === 'true'
  ...
  const checkJqueryPresent = () => {
    ...
    if (window.jQuery != null) {
      if (process.env.VUE_APP_ZAMMAD_FEEDBACK_ENABLED === 'true') {
        ...
        zammadFormScriptLink.defer = true;
      ...
      if (process.env.VUE_APP_ZAMMAD_CHAT_ENABLED === 'true') {
        ...
        zammadChatScriptLink.defer = true;
  ...
  interval = setInterval(checkJqueryPresent, 10);
}
