      ...
      <div class="list d-none d-md-block left-edge">
        <div class="channelshealth-table" v-if="loaded">
          <table class="w-100">
            <thead>
              <tr>
                <th class="w-position">{{ $t('channelshealth.headersYourChannels') }}</th>
                <th>{{ $t('channelshealth.headersLastHandshake') }}</th>
                <th>{{ $t('channelshealth.headersActivity') }}</th>
              </tr>
            </thead>
            <tbody v-if="noData">
              <tr>
                <td colspan="8" class="w-empty">{{ $t('channelshealth.noData') }}</td>
              </tr>
            </tbody>
