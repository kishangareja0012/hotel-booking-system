  ...
  >
    ...
    <div class="content-modal content-bank">
      <div class="header-bank-modal">
        <h4> {{ $t('payments.methodsBankTransfer') }} </h4>
      ...
      <div class="info">
        <div class="table">
          <div class="hold-info">
            <div class="title">
              {{ $t('payments.bankTransferLabelsHolder') }}
            </div>
          ...
          <div class="hold-info">
            <div class="title">
              {{ $t('payments.bankTransferLabelsBank') }}
            </div>
            <div class="title-normal">
              {{ bankDetails.bank }}
            </div>
          ...
          <div class="hold-info">
            <div class="title">
              {{ $t('payments.bankTransferLabelsIban') }}
            </div>
            <div class="title-normal">
              {{ bankDetails.iban }}
            </div>
          ...
          <div class="hold-info">
            <div class="title">
              {{ $t('payments.bankTransferLabelsBic') }}
            </div>
            <div class="title-normal">
              {{ bankDetails.bic }}
            </div>
