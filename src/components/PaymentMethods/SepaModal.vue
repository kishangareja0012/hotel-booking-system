    ...
    <div>
      <div class="content-modal content-modal-sepa">
        <div class="modal-header">
          ...
          <p>
            <icon class="icon mr-1 mb-1" width="12" height="12" type="info-circle"/> {{ $t('payments.sepaInfo') }}
          </p>
        </div>
        <ValidationObserver ref="form" slim v-slot="{ handleSubmit }">
          <b-form @submit.prevent.stop="handleSubmit(submitPaymentMethod)" novalidate>
            <label class="text-md">
              {{ $t('payments.sepaFormLabelsCreditorId') }}
            </label>
            <ValidatedField v-model="form.creditorId"
                            ...
                            name="creditorId"/>
            <label class="text-md">
              {{ $t('payments.sepaFormLabelsAccount') }}
            </label>
            <ValidatedField v-model="form.accountHolder"
                            ...
                            name="accountHolder"/>
            <label class="text-md">
              {{ $t('payments.sepaFormLabelsEmail') }}
            </label>
