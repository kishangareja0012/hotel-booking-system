    ...
    computed: {
      title() {
        ...
        return this.value == null || !this.value
          ? (this.placeholder || this.$t('datepicker.noValue'))
          : moment(obj).format(this.$t('datepicker.valueFormat'));
      },
      monthYear() {
        const my = moment(this.current.toDate()).format(this.$t('datepicker.titleFormat'));
