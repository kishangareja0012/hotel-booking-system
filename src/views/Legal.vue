<template>
  <div class="page-legal">
    ...
    <template v-else-if="page != null">
      <div class="legal-breadcrumb d-none d-md-block">
        <router-link :to="{ name: 'legal' }">{{ $t('legal.title') }}</router-link>
        ...
        const pages = [
          {
            id: 6,
            slug: 'legal-notice',
            title: this.$t('legal.legalNotice'),
          },
          {
            id: 4,
            slug: 'terms-and-conditions',
            title: this.$t('legal.termsAndConditions'),
          },
          {
            id: 11,
            slug: 'privacy-policy',
          ...
          },
          {
            ...
            title: this.$t('legal.dataProcessingAgreement'),
          },
          {
            id: 10,
            slug: 'data-processors',
            title: this.$t('legal.dataProcessors'),
          },
        ];
        return pages;
