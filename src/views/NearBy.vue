          ...
          <div v-if="loaded && !pending">
            <ValidationObserver ref="form">
              <div class="mb-40">
                ...
                <div class="row" v-for="(airport, idx) in airports_modified" :key="`tab-${idx}`">
                  <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.airportCode') }}</p>
                    <ValidatedField
                      required
                      ...
                      :placeholder="$t('nearby.airportCode')"
                    />
                  </div>
                  <div class="col-xl-2 col-lg-2 col-md-5 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.distance') }}</p>
                    <amount-percent
                      :no-icon="false"
                      :no-tolltip="false"
                      simple
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.units') }}</p>
                    <drop-down
                      @input="isChanged('airports', idx)"
                ...
                <b-btn pill variant="outline-primary" class="add-more" :disabled="!loaded"
                  ...
                  <span v-if="airports_modified.length">{{ $t('buttons.addMore') }}</span>
                  <span v-else>{{ $t('buttons.addNew') }}</span>
                </b-btn>
              </div>
              ...
              <div class="mb-40">
                <div class="row">
                  <div class="col-sm-12 item-head-line">
                    {{ $t('nearby.nextTrainStation') }}
                  </div>
                </div>
                <div class="row" v-for="(train, idx) in trains_modified" :key="`tab-${idx}`">
                  <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.nextTrainStationCode') }}</p>
                    <ValidatedField
                      required
                      rules="required|min:1|max:15"
                      type="text"
                      ...
                      :placeholder="$t('nearby.nextTrainStationCode')"
                    />
                  </div>
                  <div class="col-xl-2 col-lg-2 col-md-5 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.distance') }}</p>
                ...
                <b-btn pill variant="outline-primary" class="add-more" :disabled="!loaded"
                  ...
                  <icon width="10" height="11" type="plus"/>
                  <span v-if="trains_modified.length">{{ $t('buttons.addMore') }}</span>
                  <span v-else>{{ $t('buttons.addNew') }}</span>
                </b-btn>
              </div>
              ...
              <div class="mb-40">
                <div class="row">
                  <div class="col-sm-12 item-head-line">
                    {{ $t('nearby.nextMortorwayExit') }}
                  </div>
                </div>
                <div class="row" v-for="(motor, idx) in motors_modified" :key="`tab-${idx}`">
                  <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.motorwayCode') }}</p>
                    <ValidatedField
                      required
                      rules="required|min:1|max:15"
                      type="text"
                      ...
                      :placeholder="$t('nearby.motorwayCode')"
                    />
                  </div>
                  <div class="col-xl-2 col-lg-2 col-md-5 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.distance') }}</p>
                ...
                <b-btn pill variant="outline-primary" class="add-more" :disabled="!loaded"
                  ...
                  <icon width="10" height="11" type="plus"/>
                  <span v-if="motors_modified.length">{{ $t('buttons.addMore') }}</span>
                  <span v-else>{{ $t('buttons.addNew') }}</span>
                </b-btn>
              </div>
              ...
              <div class="mb-40">
                <div class="row">
                  <div class="col-sm-12 item-head-line">
                    {{ $t('nearby.publicTransportation') }}
                  </div>
                </div>
                <div class="row" v-for="(publics, idx) in publics_modified" :key="`tab-${idx}`">
                  <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.type') }}</p>
                    <drop-down
              ...
              <div class="mb-40">
                ...
                <div class="row" v-for="(center, idx) in city_centers_modified" :key="`tab-${idx}`">
                  <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.cityCenterCode') }}</p>
                    <ValidatedField
                      required
                      rules="required|min:1|max:15"
                      type="text"
                      ...
                      :placeholder="$t('nearby.cityCenterCode')"
                    />
                  </div>
                  <div class="col-xl-2 col-lg-2 col-md-5 col-sm-12 input-padding-right">
                    <p class="head-line-nearby">{{ $t('nearby.distance') }}</p>
                ...
                <b-btn pill variant="outline-primary" class="add-more" :disabled="!loaded"
                  ...
                  <icon width="10" height="11" type="plus"/>
                  <span v-if="city_centers_modified.length">{{ $t('buttons.addMore') }}</span>
                  <span v-else>{{ $t('buttons.addNew') }}</span>
                </b-btn>
              </div>
            </ValidationObserver>
    ...
    data() {
      return {
        ...
        transportation_types: [
          {
            id: 'bus',
            text: this.$t('nearby.busStation'),
          },
          {
            id: 'ferry',
            text: this.$t('nearby.ferryStation'),
          },
          {
            id: 'metro',
            text: this.$t('nearby.metroStation'),
          },
          // {
          //   id: 'trolley',
          //   text: this.$t('nearby.trolley-station'),
          // },
        ],
      };
    },
    methods: {
      ...
      async onSubmit() {
        ...
        try {
          ...
          this.$toastr.s({
            title: this.$t('nearby.alertSaved'),
            msg: '',
            timeout: 3000,
            progressbar: false,
          });
