  ...
  export default {
    ...
    data() {
      return {
        ...
        tabs: [
          { id: 'personal-data', title: this.$t('profile.tabsPersonalData') },
          { id: 'login-data', title: this.$t('profile.tabsLoginData') },
          { id: 'formats-language-data', title: this.$t('profile.tabsFormatsLanguageData') },
        ],
        profile: {},
        profileImage: null,
        userData: null,
    ...
    computed: {
      ...
      dateFormats() {
        return this.$t('profile.dateFormats');
      },
    ...
    methods: {
      ...
      async onSubmit() {
        ...
        try {
          ...
          this.$toastr.s({
            title: this.$t('profile.alertSaved'),
            msg: '',
            timeout: 3000,
            progressbar: false,
          });
