        ...
        <div class="panel panel-content d-none d-md-block">
          <div class="list d-none d-md-block left-edge groupModal">
            <form @submit.prevent.stop="handleSubmit(onSubmit)" novalidate>
              <div class="row">
                <div class="col-12">
                  <label class="text-xs" for="name">{{ $t('group.modalFieldGroupTitle') }}</label>
                  <ValidatedField
                    :disabled="pending"
                    type="text" id="name" name="name" class="mb-2"
                    v-model.trim="form.name"
                    :placeholder="$t('group.modalFieldGroupPlaceholder')"
              ...
              <div class="row">
                <div class="col-12">
                  <label class="text-xs">{{ $t('group.modalFieldBdomainTitle') }}</label>
                  <ValidatedField
                    :disabled="pending || form.domains_locked"
                    v-model.trim="form.b_domain"
                    :placeholder="$t('group.modalFieldBdomainPlaceholder')"
                ...
                <div class="col-12">
                  <label class="text-xs">{{ $t('group.modalFieldEdomainTitle') }}</label>
                  <ValidatedField
                    :disabled="pending || form.domains_locked"
                    v-model.trim="form.e_domain"
                    :placeholder="$t('group.modalFieldEdomainPlaceholder')"
              ...
              <div class="row">
                <div class="col-12">
                  <label class="text-xs">{{ $t('group.modalColorTitle') }}</label>
              ...
              <div class="row">
                <div class="col-12 wrapperColorPicker">
                  <div v-if="form.style.color_schema.rgba">
                    <p v-html="$t('group.modalColorMain')"></p>
                    <span
                  ...
                  <div
                    class="colorText">
                    <p v-html="$t('group.modalColorTextTitle')"></p>
                    ...
                    <!-- <div class="wrapperColor">
                      <div>
                        ...
                        <radio v-model="textColor" val="white" :disabled="pending">
                          {{ $t('group.modalColorTextColorwhite') }}
                        </radio>
                      </div>
                      ...
                      <div>
                        ...
                        <radio v-model="textColor" val="black" :disabled="pending">
                          {{ $t('group.modalColorTextColordark') }}
                        </radio>
                      </div>
                    </div> -->
                  </div>
