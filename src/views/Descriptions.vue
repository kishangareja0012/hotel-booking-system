    ...
    methods: {
        ...
        const fields = [
          {
            ...
            title: this.$t('description.descriptionLong'),
          },
          {
            name: 'description_short',
            title: this.$t('description.descriptionShort'),
          },
          {
            name: 'liability',
            title: this.$t('description.liability'),
          },
          {
            name: 'location',
            title: this.$t('description.location'),
          },
          {
            name: 'directions',
            title: this.$t('description.directions'),
          },
          {
            name: 'insider_tips',
            title: this.$t('description.insiderTips'),
          },
        ];
        const data = {};
      ...
      async onSubmit() {
        ...
        try {
          ...
          this.$toastr.s({
            title: this.$t('description.alertSaved'),
            msg: '',
            timeout: 3000,
            progressbar: false,
          });
